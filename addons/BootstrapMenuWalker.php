		...
		if(\strcasecmp($item->attr_title, 'divider') == 0 && $depth === 1) {
			...
			if($eve_page_corp_eve_ID) {
				if(isset($this->themeOptions['show_corp_logos']['show'])) {
					if(EveOnline\Helper\ImageHelper::checkCachedImage('corporation', $yf_page_corp_eve_ID . '_32.png') === true) {
						$corpLogoPath = EveOnline\Helper\ImageHelper::getImageCacheUri() . 'corporation' . '/' . $yf_page_corp_eve_ID . '_32.png';
					} else {
						EveOnline\Helper\ImageHelper::cacheRemoteImageFile('corporation', $this->eveApi->getImageServerEndpoint('corporation') . $yf_page_corp_eve_ID . '_32.png');
