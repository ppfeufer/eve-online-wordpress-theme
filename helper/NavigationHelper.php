		...
		if($wp_query->max_num_pages > 1) {
			...
			<nav id="<?php echo $nav_id; ?>" class="navigation post-navigation clearfix" role="navigation">
				...
				<div class="nav-previous pull-left">
					<?php // EveOnline\eve_next_posts_link(\__('<span class="meta-nav">&larr;</span> Older posts', 'eve-online')); ?>
					<?php self::getNextPostsLink(\__('<span class="meta-nav">&larr;</span> Older posts', 'eve-online'), 0, true); ?>
				</div>
				<div class="nav-next pull-right">
					<?php // EveOnline\eve_previous_posts_link(\__('Newer posts <span class="meta-nav">&rarr;</span>', 'eve-online')); ?>
