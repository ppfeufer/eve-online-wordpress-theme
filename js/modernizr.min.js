...
!*/
Modernizr.addTest("cookies",function(){try{document.cookie="cookietest=1";var ret=document.cookie.indexOf("cookietest=")!=-1;document.cookie="cookietest=1; expires=Thu, 01-Jan-1970 00:00:01 GMT";return ret}catch(e){return false}});
/*!
{
...
!*/
Modernizr.addTest("customprotocolhandler",function(){if(!navigator.registerProtocolHandler){return false}try{navigator.registerProtocolHandler("thisShouldFail")}catch(e){return e instanceof TypeError}return false});
/*!
{
  "name": "CustomEvent",
...
!*/
Modernizr.addTest("notification",function(){if(!window.Notification||!window.Notification.requestPermission){return false}if(window.Notification.permission==="granted"){return true}try{new window.Notification("")}catch(e){if(e.name==="TypeError"){return false}}return true});
/*!
{
  "name": "postMessage",
...
!*/
Modernizr.addTest("templatestrings",function(){var supports;try{eval("``");supports=true}catch(e){}return !!supports});
/*!
{
  "name": "Typed arrays",
...
!*/
var supports=false;try{supports="WebSocket" in window&&window.WebSocket.CLOSING===2}catch(e){}Modernizr.addTest("websockets",supports);
/*!
{
  "name": "XDomainRequest",
...
!*/
var CSS=window.CSS;Modernizr.addTest("cssescape",CSS?typeof CSS.escape=="function":false);
/*!
{
  "name": "CSS Supports",
  "property": "supports",
...
!*/
Modernizr.addTest("target",function(){var doc=window.document;if(!("querySelectorAll" in doc)){return false}try{doc.querySelectorAll(":target");return true}catch(e){return false}});
/*!
{
  "name": "microdata",
  "property": "microdata",
...
!*/
Modernizr.addTest("es5date",function(){var isoDate="2013-04-12T06:06:37.307Z",canParseISODate=false;try{canParseISODate=!!Date.parse(isoDate)}catch(e){}return !!(Date.now&&Date.prototype&&Date.prototype.toISOString&&Date.prototype.toJSON&&canParseISODate)});
/*!
{
  "name": "ES5 Function",
...
!*/
Modernizr.addTest("es5undefined",function(){var result,originalUndefined;try{originalUndefined=window.undefined;window.undefined=12345;result=typeof window.undefined==="undefined";window.undefined=originalUndefined}catch(e){return false}return result});
/*!
{
  "name": "ES5",
  "property": "es5",
...
!*/
Modernizr.addTest("generators",function(){try{new Function("function* test() {}")()}catch(e){return false}return true});
/*!
{
  "name": "ES6 Math",
  "property": "es6math",
...
!*/
Modernizr.addTest("lowbandwidth",function(){var connection=navigator.connection||{type:0};return connection.type==3||connection.type==4||/^[23]g$/.test(connection.type)});
/*!
{
...
!*/
Modernizr.addTest("xhrresponsetype",(function(){if(typeof XMLHttpRequest=="undefined"){return false}var xhr=new XMLHttpRequest();xhr.open("get","/",true);return"response" in xhr}()));
/*!
{
...
!*/
Modernizr.addTest("urlparser",function(){var url;try{url=new URL("http://modernizr.com/");return url.href==="http://modernizr.com/"}catch(e){return false}});
/*!
{
...
!*/
Modernizr.addTest("websocketsbinary",function(){var protocol="https:"==location.protocol?"wss":"ws",protoBin;if("WebSocket" in window){if(protoBin="binaryType" in WebSocket.prototype){return protoBin}try{return !!(new WebSocket(protocol+"://.").binaryType)}catch(e){}}return false});
/*!
{
...
!*/
Modernizr.addTest("contains",is(String.prototype.contains,"function"));var docElement=document.documentElement;
/*!
{
  "name": "Context menus",
...
!*/
Modernizr.addAsyncTest(function(){var image=new Image();image.onload=image.onerror=function(){addTest("jpegxr",image.width==1,{aliases:["jpeg-xr"]})};image.src="data:image/vnd.ms-photo;base64,SUm8AQgAAAAFAAG8AQAQAAAASgAAAIC8BAABAAAAAQAAAIG8BAABAAAAAQAAAMC8BAABAAAAWgAAAMG8BAABAAAAHwAAAAAAAAAkw91vA07+S7GFPXd2jckNV01QSE9UTwAZAYBxAAAAABP/gAAEb/8AAQAAAQAAAA=="});
/*!
{
  "name": "Webp Alpha",
  "async": true,
...
!*/
Modernizr.addAsyncTest(function(){var image=new Image();image.onerror=function(){addTest("webpalpha",false,{aliases:["webp-alpha"]})};image.onload=function(){addTest("webpalpha",image.width==1,{aliases:["webp-alpha"]})};image.src="data:image/webp;base64,UklGRkoAAABXRUJQVlA4WAoAAAAQAAAAAAAAAAAAQUxQSAwAAAABBxAR/Q9ERP8DAABWUDggGAAAADABAJ0BKgEAAQADADQlpAADcAD++/1QAA=="});
/*!
{
  "name": "Webp Animation",
  "async": true,
...
!*/
Modernizr.addAsyncTest(function(){var image=new Image();image.onerror=function(){addTest("webpanimation",false,{aliases:["webp-animation"]})};image.onload=function(){addTest("webpanimation",image.width==1,{aliases:["webp-animation"]})};image.src="data:image/webp;base64,UklGRlIAAABXRUJQVlA4WAoAAAASAAAAAAAAAAAAQU5JTQYAAAD/////AABBTk1GJgAAAAAAAAAAAAAAAAAAAGQAAABWUDhMDQAAAC8AAAAQBxAREYiI/gcA"});
/*!
{
  "name": "Webp Lossless",
  "async": true,
...
!*/
Modernizr.addAsyncTest(function(){var image=new Image();image.onerror=function(){addTest("webplossless",false,{aliases:["webp-lossless"]})};image.onload=function(){addTest("webplossless",image.width==1,{aliases:["webp-lossless"]})};image.src="data:image/webp;base64,UklGRh4AAABXRUJQVlA4TBEAAAAvAAAAAAfQ//73v/+BiOh/AAA="});
/*!
{
  "name": "Webp",
  "async": true,
...
!*/
Modernizr.addTest("hashchange",function(){if(hasEvent("hashchange",window)===false){return false}return(document.documentMode===undefined||document.documentMode>7)});
/*!
{
...
!*/
Modernizr.addTest("contenteditable",function(){if(!("contentEditable" in docElement)){return}var div=createElement("div");div.contentEditable=true;return div.contentEditable==="true"});
/*!
{
  "name": "Emoji",
  "property": "emoji"
...
!*/
Modernizr.addTest("emoji",function(){if(!Modernizr.canvastext){return false}var pixelRatio=window.devicePixelRatio||1;var offset=12*pixelRatio;var node=createElement("canvas");var ctx=node.getContext("2d");ctx.fillStyle="#f00";ctx.textBaseline="top";ctx.font="32px Arial";ctx.fillText("\ud83d\udc28",0,0);return ctx.getImageData(offset,offset,1,1).data[0]!==0});
/*!
{
  "name": "HTML Imports",
  "notes": [
...
!*/
Modernizr.addTest("vml",function(){var containerDiv=createElement("div");var supports=false;var shape;if(!isSVG){containerDiv.innerHTML='<v:shape id="vml_flag1" adj="1" />';shape=containerDiv.firstChild;if("style" in shape){shape.style.behavior="url(#default#VML)"}supports=shape?typeof shape.adj=="object":true}return supports});
/*!
{
...
!*/
Modernizr.addTest("webgl",function(){var canvas=createElement("canvas");var supports="probablySupportsContext" in canvas?"probablySupportsContext":"supportsContext";if(supports in canvas){return canvas[supports]("webgl")||canvas[supports]("experimental-webgl")}return"WebGLRenderingContext" in window});
/*!
{
...
!*/
Modernizr.addTest("canvasblending",function(){if(Modernizr.canvas===false){return false}var ctx=createElement("canvas").getContext("2d");try{ctx.globalCompositeOperation="screen"}catch(e){}return ctx.globalCompositeOperation==="screen"});
/*!
{
...
!*/
Modernizr.addTest("canvaswinding",function(){if(Modernizr.canvas===false){return false}var ctx=createElement("canvas").getContext("2d");ctx.rect(0,0,10,10);ctx.rect(2,2,6,6);return ctx.isPointInPath(5,5,"evenodd")===false});
/*!
{
...
!*/
Modernizr.addTest("bgpositionshorthand",function(){var elem=createElement("a");var eStyle=elem.style;var val="right 10px bottom 10px";eStyle.cssText="background-position: "+val+";";return(eStyle.backgroundPosition===val)});
/*!
{
  "name": "CSS Calc",
  "property": "csscalc",
...
!*/
Modernizr.addTest("cubicbezierrange",function(){var el=createElement("a");el.style.cssText=prefixes.join("transition-timing-function:cubic-bezier(1,0,0,1.1); ");return !!el.style.length});
/*!
{
  "name": "CSS Gradients",
...
!*/
Modernizr.addTest("csspointerevents",function(){var style=createElement("a").style;style.cssText="pointer-events:auto";return style.pointerEvents==="auto"});
/*!
{
...
!*/
Modernizr.addTest("cssremunit",function(){var style=createElement("a").style;try{style.fontSize="3rem"}catch(e){}return(/rem/).test(style.fontSize)});
/*!
{
  "name": "CSS rgba",
  "caniuse": "css3-colors",
...
!*/
Modernizr.addTest("bdi",function(){var div=createElement("div");var bdi=createElement("bdi");bdi.innerHTML="&#1573;";div.appendChild(bdi);docElement.appendChild(div);var supports=((window.getComputedStyle?getComputedStyle(bdi,null):bdi.currentStyle).direction==="rtl");docElement.removeChild(div);return supports});
/*!
{
  "name": "output Element",
  "property": "outputelem",
...
!*/
Modernizr.addTest("ruby",function(){var ruby=createElement("ruby");var rt=createElement("rt");var rp=createElement("rp");var displayStyleProperty="display";var fontSizeStyleProperty="fontSize";ruby.appendChild(rp);ruby.appendChild(rt);docElement.appendChild(ruby);if(getStyle(rp,displayStyleProperty)=="none"||getStyle(ruby,displayStyleProperty)=="ruby"&&getStyle(rt,displayStyleProperty)=="ruby-text"||getStyle(rp,fontSizeStyleProperty)=="6pt"&&getStyle(rt,fontSizeStyleProperty)=="6pt"){cleanUp();return true}else{cleanUp();return false}function getStyle(element,styleProperty){var result;if(window.getComputedStyle){result=document.defaultView.getComputedStyle(element,null).getPropertyValue(styleProperty)}else{if(element.currentStyle){result=element.currentStyle[styleProperty]}}return result}function cleanUp(){docElement.removeChild(ruby);ruby=null;rt=null;rp=null}});
/*!
{
  "name": "Template Tag",
  "property": "template",
...
!*/
Modernizr.addTest("texttrackapi",typeof(createElement("video").addTextTrack)==="function");Modernizr.addTest("track","kind" in createElement("track"));
/*!
{
...
!*/
Modernizr.addTest("unknownelements",function(){var a=createElement("a");a.innerHTML="<xyz></xyz>";return a.childNodes.length===1});
/*!
{
...
!*/
Modernizr.addTest("fileinput",function(){if(navigator.userAgent.match(/(Android (1.0|1.1|1.5|1.6|2.0|2.1))|(Windows Phone (OS 7|8.0))|(XBLWP)|(ZuneWP)|(w(eb)?OSBrowser)|(webOS)|(Kindle\/(1.0|2.0|2.5|3.0))/)){return false}var elem=createElement("input");elem.type="file";return !elem.disabled});
/*!
{
...
!*/
Modernizr.addTest("fileinputdirectory",function(){var elem=createElement("input"),dir="directory";elem.type="file";if(dir in elem){return true}else{for(var i=0,len=domPrefixes.length;i<len;i++){if(domPrefixes[i]+dir in elem){return true}}}return false});
/*!
{
...
!*/
Modernizr.addAsyncTest(function(){var width1,width2,test;var image=createElement("img");var isSizes="sizes" in image;if(!isSizes&&("srcset" in image)){width2="data:image/gif;base64,R0lGODlhAgABAPAAAP///wAAACH5BAAAAAAALAAAAAACAAEAAAICBAoAOw==";width1="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==";test=function(){addTest("sizes",image.width==2)};image.onload=test;image.onerror=test;image.setAttribute("sizes","9px");image.srcset=width1+" 1w,"+width2+" 8w";image.src=width1}else{addTest("sizes",isSizes)}});
/*!
{
...
!*/
Modernizr.addAsyncTest(function(){Modernizr.webglextensions=new Boolean(false);if(!Modernizr.webgl){return}var canvas;var ctx;var exts;try{canvas=createElement("canvas");ctx=canvas.getContext("webgl")||canvas.getContext("experimental-webgl");exts=ctx.getSupportedExtensions()}catch(e){return}if(ctx!==undefined){Modernizr.webglextensions=new Boolean(true)}for(var i=-1,len=exts.length;++i<len;){Modernizr.webglextensions[exts[i]]=true}canvas=undefined});function cssToDOM(name){return name.replace(/([a-z])-([a-z])/g,function(str,m1,m2){return m1+m2.toUpperCase()}).replace(/^-/,"")}function domToCSS(name){return name.replace(/([A-Z])/g,function(str,m1){return"-"+m1.toLowerCase()}).replace(/^ms-/,"-ms-")}function getBody(){var body=document.body;if(!body){body=createElement(isSVG?"svg":"body");body.fake=true}return body}
/*!
  {
  "name": "Flash",
  "property": "flash",
...
!*/
Modernizr.addTest("mathml",function(){var ret;testStyles("#modernizr{position:absolute;display:inline-block}",function(node){node.innerHTML+="<math><mfrac><mi>xx</mi><mi>yy</mi></mfrac></math>";ret=node.offsetHeight>node.offsetWidth});return ret});
/*!
{
  "name": "Touch Events",
...
!*/
testStyles("#modernizr{display: table; direction: ltr}#modernizr div{display: table-cell; padding: 10px}",function(elem){var ret;var child=elem.childNodes;ret=child[0].offsetLeft<child[1].offsetLeft;Modernizr.addTest("displaytable",ret,{aliases:["display-table"]})},2);
/*!
{
  "name": "@font-face",
  "property": "fontface",
...
!*/
Modernizr.addTest("hairline",function(){return testStyles("#modernizr {border:.5px solid transparent}",function(elem){return elem.offsetHeight===1})});
/*!
{
...
!*/
Modernizr.addTest("cssinvalid",function(){return testStyles("#modernizr input{height:0;border:0;padding:0;margin:0;width:10px} #modernizr input:invalid{width:50px}",function(elem){var input=createElement("input");input.required=true;elem.appendChild(input);return input.clientWidth>10})});
/*!
{
...
!*/
testStyles("#modernizr div {width:100px} #modernizr :last-child{width:200px;display:block}",function(elem){Modernizr.addTest("lastchild",elem.lastChild.offsetWidth>elem.firstChild.offsetWidth)},2);
/*!
{
...
!*/
testStyles("#modernizr div {width:1px} #modernizr div:nth-child(2n) {width:2px;}",function(elem){var elems=elem.getElementsByTagName("div");var correctWidths=true;for(var i=0;i<5;i++){correctWidths=correctWidths&&elems[i].offsetWidth===i%2+1}Modernizr.addTest("nthchild",correctWidths)},5);
/*!
{
...
!*/
testStyles("#modernizr{overflow: scroll; width: 40px; height: 40px; }#"+prefixes.join("scrollbar{width:0px} #modernizr::").split("#").slice(1).join("#")+"scrollbar{width:0px}",function(node){Modernizr.addTest("cssscrollbar",node.scrollWidth==40)});
/*!
{
...
!*/
Modernizr.addTest("siblinggeneral",function(){return testStyles("#modernizr div {width:100px} #modernizr div ~ div {width:200px;display:block}",function(elem){return elem.lastChild.offsetWidth==200},2)});
/*!
{
...
!*/
Modernizr.addTest("cssvalid",function(){return testStyles("#modernizr input{height:0;border:0;padding:0;margin:0;width:10px} #modernizr input:valid{width:50px}",function(elem){var input=createElement("input");elem.appendChild(input);return input.clientWidth>10})});
/*!
{
  "name": "CSS vh unit",
  "property": "cssvhunit",
...
!*/
Modernizr.addTest("details",function(){var el=createElement("details");var diff;if(!("open" in el)){return false}testStyles("#modernizr details{display:block}",function(node){node.appendChild(el);el.innerHTML="<summary>a</summary>b";diff=el.offsetHeight;el.open=true;diff=diff!=el.offsetHeight});return diff});
/*!
{
  "name": "onInput Event",
  "property": "oninput",
...
!*/
Modernizr.addTest("oninput",function(){var input=createElement("input");var supportsOnInput;input.setAttribute("oninput","return");if(hasEvent("oninput",docElement)||typeof input.oninput=="function"){return true}try{var testEvent=document.createEvent("KeyboardEvent");supportsOnInput=false;var handler=function(e){supportsOnInput=true;e.preventDefault();e.stopPropagation()};testEvent.initKeyEvent("keypress",true,true,window,false,false,false,false,0,"e".charCodeAt(0));docElement.appendChild(input);input.addEventListener("input",handler,false);input.focus();input.dispatchEvent(testEvent);input.removeEventListener("input",handler,false);docElement.removeChild(input)}catch(e){supportsOnInput=false}return supportsOnInput});
/*!
{
...
!*/
Modernizr.addTest("csschunit",function(){var elemStyle=modElem.elem.style;var supports;try{elemStyle.fontSize="3ch";supports=elemStyle.fontSize.indexOf("ch")!==-1}catch(e){supports=false}return supports});
/*!
{
...
!*/
Modernizr.addTest("cssexunit",function(){var elemStyle=modElem.elem.style;var supports;try{elemStyle.fontSize="3ex";supports=elemStyle.fontSize.indexOf("ex")!==-1}catch(e){supports=false}return supports});function contains(str,substr){return !!~(""+str).indexOf(substr)}
/*!
{
...
!*/
Modernizr.addTest("hsla",function(){var style=createElement("a").style;style.cssText="background-color:hsla(120,40%,100%,.5)";return contains(style.backgroundColor,"rgba")||contains(style.backgroundColor,"hsla")});function roundedEquals(a,b){return a-1===b||a===b||a+1===b}
/*!
{
  "name": "CSS vmax unit",
...
!*/
Modernizr.addTest("xhrresponsetypetext",testXhrType("text"));var toStringFn=({}).toString;
/*!
{
  "name": "SVG clip paths",
...
!*/
Modernizr.addTest("forcetouch",function(){if(!hasEvent(prefixed("mouseforcewillbegin",window,false),window)){return false}return MouseEvent.WEBKIT_FORCE_AT_MOUSE_DOWN&&MouseEvent.WEBKIT_FORCE_AT_FORCE_MOUSE_DOWN});
/*!
{
  "name": "Fullscreen API",
  "property": "fullscreen",
...
!*/
var indexeddb;try{indexeddb=prefixed("indexedDB",window)}catch(e){}Modernizr.addTest("indexeddb",!!indexeddb);if(!!indexeddb){Modernizr.addTest("indexeddb.deletedatabase","deleteDatabase" in indexeddb)}
/*!
{
  "name": "IndexedDB Blob",
...
!*/
Modernizr.addTest("quotamanagement",function(){var tempStorage=prefixed("temporaryStorage",navigator);var persStorage=prefixed("persistentStorage",navigator);return !!(tempStorage&&persStorage)});
/*!
{
...
!*/
Modernizr.addTest("lowbattery",function(){var minLevel=0.2;var battery=prefixed("battery",navigator);return !!(battery&&!battery.charging&&battery.level<=minLevel)});
/*!
{
...
!*/
var crypto=prefixed("crypto",window);var supportsGetRandomValues;if(crypto&&"getRandomValues" in crypto&&"Uint32Array" in window){var array=new Uint32Array(10);var values=crypto.getRandomValues(array);supportsGetRandomValues=values&&is(values[0],"number")}Modernizr.addTest("getrandomvalues",!!supportsGetRandomValues);
/*!
{
...
!*/
var url=prefixed("URL",window,false);url=url&&window[url];Modernizr.addTest("bloburls",url&&"revokeObjectURL" in url&&"createObjectURL" in url);
/*!
{
...
!*/
Modernizr.addTest("matchmedia",!!prefixed("matchMedia",window));function testAllProps(prop,value,skipValueTest){return testPropsAll(prop,undefined,undefined,value,skipValueTest)}ModernizrProto.testAllProps=testAllProps;
/*!
{
  "name": "Font Ligatures",
  "property": "ligatures",
...
!*/
Modernizr.addTest("bgpositionxy",function(){return testAllProps("backgroundPositionX","3px",true)&&testAllProps("backgroundPositionY","5px",true)});
/*!
{
...
!*/
Modernizr.addTest("userselect",testAllProps("userSelect","none",true));testRunner();setClasses(classes);delete ModernizrProto.addTest;delete ModernizrProto.addAsyncTest;for(var i=0;i<Modernizr._q.length;i++){Modernizr._q[i]()}window.Modernizr=Modernizr})(window,document);